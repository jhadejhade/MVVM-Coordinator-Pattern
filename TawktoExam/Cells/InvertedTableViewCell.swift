...
class InvertedTableViewCell: UITableViewCell, UsersElementCell {
    ...
    var noteButtonImage: UIImageView = {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        noteButtonImage.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate([nameLabel.topAnchor.constraint(equalTo: topAnchor, constant: 16),
                                     ...
                                     nameLabel.rightAnchor.constraint(equalTo: noteButtonImage.leftAnchor, constant: 8)])
        ...
        // MARK: Note Button Image Constraint
        NSLayoutConstraint.activate([ noteButtonImage.centerYAnchor.constraint(equalTo: centerYAnchor, constant: 0),
                                      noteButtonImage.rightAnchor.constraint(equalTo: rightAnchor, constant: -16),
                                      NSLayoutConstraint(item: noteButtonImage, attribute: .height, relatedBy: .equal, toItem: noteButtonImage, attribute: .width, multiplier: 1, constant: 0),
                                      NSLayoutConstraint(item: noteButtonImage, attribute: .width, relatedBy: .equal, toItem: self, attribute: .width, multiplier: 0.07, constant: 0)])
    }
